...
export const HomePage = ({ year, setYear, onNavigate, onNavigateDomain }: HomePageProps) => {
  return (
    <main className="min-h-screen cursor-none bg-[var(--color-bg-main)] selection:bg-[var(--color-accent-primary)] selection:text-[var(--color-bg-main)] transition-colors duration-500 overflow-x-hidden">
      <CustomCursor />
      <BackgroundEffects />
